...
import { Bot, CheckCircle2, Download, ShieldCheck } from "lucide-react";
import { Button } from "@/components/ui/button";
import type { LeadFieldKey } from "../landing-config";
...
type LeadFormSectionProps = {
  ...
  consentTitle: string;
  consentCopy: string;
  renderLuxuryBadge: (label: string) => React.ReactNode;
  handleLeadSubmit: (event: React.FormEvent<HTMLFormElement>) => Promise<void>;
  validationMessage: { field: LeadFieldKey; message: string } | null;
  firstNameRef: React.RefObject<HTMLInputElement | null>;
  lastNameRef: React.RefObject<HTMLInputElement | null>;
  emailRef: React.RefObject<HTMLInputElement | null>;
  privacyRef: React.RefObject<HTMLInputElement | null>;
  altchaRef: React.RefObject<HTMLDivElement | null>;
  formData: { firstName: string; lastName: string; email: string };
  setFormData: React.Dispatch<
    React.SetStateAction<{ firstName: string; lastName: string; email: string }>
  >;
  setValidationMessage: React.Dispatch<
    React.SetStateAction<{ field: LeadFieldKey; message: string } | null>
  >;
  altchaStrings: string;
  privacyAccepted: boolean;
  setPrivacyAccepted: React.Dispatch<React.SetStateAction<boolean>>;
  privacyCheckboxLabel: string;
  isSubmitting: boolean;
  automationFeedback: { type: "success" | "error"; userName: string } | null;
};
...
export function LeadFormSection({
  ...
  return (
    <section
      id="dossier"
      ref={leadFormRef as unknown as React.RefObject<HTMLElement>}
      className="relative py-20 pb-32 bg-linear-to-b from-brown-dark via-[#22170f] to-brown-dark overflow-hidden"
      style={{
        opacity: leadFormVisible ? 1 : 0,
        transform: leadFormVisible ? "translateY(0px)" : "translateY(50px)",
                ...
                >
                  ...
                  <div className="grid md:grid-cols-[0.7fr_1.3fr] gap-3">
                    <div>
                      ...
                      <input
                        ref={firstNameRef as unknown as React.RefObject<HTMLInputElement>}
                        id="lead-first-name"
                        name="firstName"
                        type="text"
                    ...
                    <div>
                      ...
                      <input
                        ref={lastNameRef as unknown as React.RefObject<HTMLInputElement>}
                        id="lead-last-name"
                        name="lastName"
                        type="text"
                  ...
                  <div>
                    ...
                    <input
                      ref={emailRef as unknown as React.RefObject<HTMLInputElement>}
                      type="email"
                      name="email"
                      id="lead-email"
                      required
                  ...
                  <div
                    ref={altchaRef as unknown as React.RefObject<HTMLDivElement>}
                  ...
                  >
                    ...
                    >
                      <input
                        ref={privacyRef as unknown as React.RefObject<HTMLInputElement>}
                        id="lead-privacy"
                        name="privacy"
                        type="checkbox"
