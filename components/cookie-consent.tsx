      ...
      {open ? (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/55 px-4 py-6 backdrop-blur-sm sm:items-center" role="dialog" aria-modal="true" aria-labelledby="azure-cookie-title">
          <div className="w-full max-w-lg rounded-3xl border border-cyan-300/20 bg-slate-950 p-6 text-white shadow-2xl">
            <h2 id="azure-cookie-title" className="text-2xl font-semibold">{settings ? "Gestionar cookies" : "Preferencias de cookies"}</h2>
            <p className="mt-3 text-sm leading-6 text-slate-300">Este caso de estudio utiliza cookies necesarias y puede guardar preferencias opcionales de análisis o marketing si las autorizas.</p>
            {settings ? (
